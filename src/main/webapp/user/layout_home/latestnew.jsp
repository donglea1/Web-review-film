...
<div class="row">
	<div class="col-md-9">
		<div class="ads adsv2">
			<img src="./user/images/uploads/ads2.png" alt="">
		</div>
		<div class="title-hd">
			<h2>Latest news</h2>
		...
		<div class="latestnewv2">
			<div class="blog-item-style-2">
				<a href="blogdetail.html"><img src="./user/images/uploads/blogv21.jpg"
					alt=""></a>
				<div class="blog-it-infor">
					<h3>
						<a href="blogdetail.html">Godzilla: King Of The Monsters Adds
							O’Shea Jackson Jr</a>
					</h3>
			...
			<div class="blog-item-style-2">
				<a href="blogdetail.html"><img src="./user/images/uploads/blogv22.jpg"
					alt=""></a>
				<div class="blog-it-infor">
					<h3>
			...
			<div class="blog-item-style-2">
				<a href="blogdetail.html"><img src="./user/images/uploads/blogv23.jpg"
					alt=""></a>
				<div class="blog-it-infor">
					<h3>
			...
			<div class="blog-item-style-2">
				<a href="blogdetail.html"><img src="./user/images/uploads/blogv24.jpg"
					alt=""></a>
				<div class="blog-it-infor">
					<h3>
						<a href="blogdetail.html">Joseph Gordon-Levitt Directing Moive
							Musical Comedy Wingmen</a>
					</h3>
					<span class="time">27 Mar 2017</span>
